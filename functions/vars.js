...
exports.FS_COLLECTIONS_EVENTS = this.FS_COLLECTIONS.events
exports.FS_COLLECTIONS_DAILY_ADMIN_REPORT = this.FS_COLLECTIONS.dailyAdminReport
exports.FS_COLLECTIONS_INFO = this.FS_COLLECTIONS.info
exports.FS_COLLECTIONS_ITEMS = this.FS_COLLECTIONS.items
exports.FS_COLLECTIONS_LOCATIONS = this.FS_COLLECTIONS.locations
...
exports.FS_AR_BID_COUNT = this.FS_AR_BIDS.bidCount
exports.FS_AR_TOTAL_BID_AMOUNT = this.FS_AR_BIDS.totalBidAmount

exports.FS_AR_ITEMS = this.FS_INFO_ADMIN_REPORT.items
exports.FS_AR_ITEM_COUNT = this.FS_AR_ITEMS.itemCount

exports.FS_AR_LOCATIONS = this.FS_INFO_ADMIN_REPORT.locations
exports.FS_AR_LOCATION_COUNT = this.FS_AR_LOCATIONS.locationCount

exports.FS_AR_USERS = this.FS_INFO_ADMIN_REPORT.users
exports.FS_AR_USER_COUNT = this.FS_AR_USERS.userCount
